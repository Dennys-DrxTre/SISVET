...
$('#data tbody').on('click', 'a[rel="detail"]', function () {
    ...
    provider = document.getElementById('provider').innerHTML = data.client.dni;
...
$(function () {
    ...
    $('#data tbody').on('click', 'a[rel="delete"]', function () {
        ...
        submit_with_ajax(window.location.pathname,'Notifiación', '¿Estas seguro de eliminar esta venta?', parameters, function () {
