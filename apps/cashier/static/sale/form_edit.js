        ...
        tblCate = $('#data2').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {                        
                        ...
                        return '<input type="number" value="'+ data +'" name="stock" max="'+ parseInt(vents.items.products[meta.row].exist_stock) +'" class="form-control form-control-sm event_input1" autocomplete="off">';
                    }
                },
                {
                    targets: [-5],
            ...
            rowCallback( row, data, displayNum, displayIndex, dataIndex ){
                $(row).find("input[name='stock']").TouchSpin({
                    ...
                    initval: parseInt(data.exist_stock)
                });
            },
